...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype._getUserDetails = function (user) {
        return {
            id: user._id,
            name: user.name,
            email: user.email
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this._getUserDetails(user)];
                }
            });
        });
    };
    //   Create user account
    UserService.prototype.create = function (name, email, hashedPassword) {
        return __awaiter(this, void 0, void 0, function () {
            var newUser;
            return __generator(this, function (_a) {
    ...
    UserService.prototype["delete"] = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userModel.findByIdAndDelete(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
